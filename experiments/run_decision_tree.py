...
def train_dataset(data_name, x, y, original_label_map=None, max_depth=10):
...
def run_decision_tree():
    ...
    train_dataset("Glass", x_glass, y_glass, glass_label_map)
    ...
    train_dataset("Breast Cancer", x_bc, y_bc, label_map)
    ...
    train_dataset("Mushroom", x_mushroom, y_mushroom, mushroom_label_map)
    ...
    train_dataset("Robot", x_robot, y_robot, robot_label_map)
    ...
    train_dataset("Pump", x_pump, y_pump, pump_label_map, max_depth=5)
