...
def train_dataset_with_knn(data_name, x, y, original_label_map=None):
...
def run_naive_bayes():
    ...
    train_dataset_with_knn("Glass", x_glass, y_glass, glass_label_map)
    knn_accuracy_vs_k(x_glass, y_glass, x_glass, y_glass, max_k=10)
    ...
    # train_dataset_with_knn("Pump", x_pump, y_pump, pump_label_map)
    ...
    train_dataset_with_knn("Breast Cancer", x_bc, y_bc, label_map)
    knn_accuracy_vs_k(x_bc, y_bc, x_bc, y_bc, max_k=10)
    ...
    train_dataset_with_knn("Mushroom", x_mushroom, y_mushroom, mushroom_label_map)
    knn_accuracy_vs_k(x_mushroom, y_mushroom, x_mushroom, y_mushroom, max_k=10)
    ...
    train_dataset_with_knn("Robot", x_robot, y_robot, robot_label_map)
    knn_accuracy_vs_k(x_robot, y_robot, x_robot, y_robot, max_k=10)

    # -----------------------------------------------------------------------------
    # -----------------------------------------------------------------------------


def knn_accuracy_vs_k(X_train, y_train, X_test, y_test, max_k=10):
